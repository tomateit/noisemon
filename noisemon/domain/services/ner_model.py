...
@spacy.registry.architectures("agreement_ner_model.v1")
def create_ner_model(
    ...
    with Model.define_operators({">>": chain}):
        ...
        model.attrs["get_entity_combinations"] = create_instance_tensor.attrs["get_entity_combinations"]
    return model


@spacy.registry.architectures("ner_classification_layer.v1")
...
@spacy.registry.architectures("ner_tensor.v1")
def create_entity_tensors(
    tok2vec: Model[List[Doc], List[Floats2d]],
    pooling: Model[Ragged, Floats2d],
    get_entity_combinations: Callable[[Doc], [List[Span}]]],
) -> Model[List[Doc], Floats2d]:
